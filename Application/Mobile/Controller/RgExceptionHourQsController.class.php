...
class RgExceptionHourQsController extends BaseAuthController
{
  ...
  public function index()
  {
    ...
    $this->get_RgExceptionHourQs_Dat($regiontype,$rgn_atpid,$snname,null);
    $this->assign('rgn_atpid',$rgn_atpid);
    $this->display('index');
  }

  public function get_RgExceptionHourQs_Dat($regiontype, $rgn_atpid, $snname,$deve_atpid)
  {
    ...
    $sql_select .= " and t.deve_type  = '时报缺失'";
  ...
  public function detail()
  {
    ...
    $RgDev=new RgDevController();
    $RgDev->get_region_list_child($pre_rgn_atpid,$regiontype,$snname);
    $this->get_RgExceptionHourQs_Dat($regiontype,$rgn_atpid,$snname,$deve_atpid);
    $this->assign('rgn_atpid',$rgn_atpid);
    $this->display();
  }
}
