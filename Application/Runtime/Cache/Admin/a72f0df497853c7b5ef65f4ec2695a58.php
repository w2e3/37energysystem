    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content" style="padding: 10px 10px 10px 10px;margin-bottom: -15px;">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <i class="fa fa-hand-o-right"></i>&nbsp;当前位置:【数据管理】/【二次数据管理】
                </div>
            </div>
        </div>
    </div>
    <div class="ibox float-e-margins">
        ...
        <div class="main-right">
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <iframe id="contentframe" src="/szny/index.php/Admin/Twicedatad/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>"  frameborder="no" width="100%" scrolling="yes" height="700px" ></iframe>
                    </div>
                </div>
            </div>
        </div>
...
//                console.log(treeNode);
               // if ('设备点' == treeNode.type) {
                    ...
                    $('#contentframe').attr('src',"/szny/index.php/Admin/Twicedatad/tableindex?rgn_atpid=" + RGN_ATPID);
