                    ...
                    <nav class="page-tabs J_menuTabs">
                        <div class="page-tabs-content">
                          <!--  <a href='/szny/index.php/Admin/Twicedatah/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>' target="_self" class='J_menuTab'>时数据</a>-->
                            ...
                            <a href='/szny/index.php/Admin/Twicedatam/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>' target="_self"  class='J_menuTab active'>月数据</a>
...
<script>
    $(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/szny/index.php/Admin/Twicedatam/getData?rgn_atpid=<?php echo ($rgn_atpid); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//            cardView: true,                    //是否显示详细视图
          //  detailView: true,                   //是否显示父子表
            ...
            onDblClickRow: function (row) {
             ...
             /*   $("#sys_dlg").load('/szny/index.php/Admin/Twicedatam/edit?id=' + row['atpid'], function() {
...
//                console.log(name+order);
    ...
    function updateInRow(id,d2m_regionid){
        window.location.href = '/szny/index.php/Admin/Examination/tableindex?id=' + id+'&d2m_regionid='+d2m_regionid;
    }
    $('#sys_search').on('click',function() {
       ...
       window.location.href='/szny/index.php/Admin/Twicedatam/tableindex?endtime='+endtime+'&starttime='+starttime+'&rgn_atpid='+regionid;
  ...
  //
    $('#sys_add').on('click',function() {
        ...
        if (1 != tablerow.length) {
            ...
            window.parent.ATP_BOX_OPEN('/szny/index.php/Admin/Twicedatam/add?id=' + tablerow[0]['d2m_atpid'], addsubmitdata);
    ...
    $('#sys_edit').on('click',function() {
        ...
        if (1 != tablerow.length) {
            ...
            window.parent.ATP_BOX_OPEN('/szny/index.php/Admin/Twicedatam/edit?id=' + tablerow[0]['d2m_atpid'], submitdata);
    ...
    function addsubmitdata(){
        if(window.parent.ATP_BOX_VALIDATE()) {
            ...
            $("#sys_dlg_form", parent.document).submit(function (e) {
                ...
                $.ajax({
                    url: '/szny/index.php/Admin/Twicedatam/addsubmit',
                    type: 'POST',
                    data: formData,
    ...
    function submitdata(){
        ...
        $("#sys_dlg_form",parent.document).submit(function (e) {
            ...
            $.ajax({
                url: '/szny/index.php/Admin/Twicedatam/submit',
                type: 'POST',
                data: formData,
                mimeType: "multipart/form-data",
                contentType: false,
...
//        $("#sys_dlg_form").submit();
    ...
    $('#sys_update').on('click',function() {
        ...
        if(tablerow.length!=1)
        {
            ...
            $("#sys_dlg").load('/szny/index.php/Admin/Twicedatam/edit?id=' + tablerow[0]['atpid'], function() {
                $('#sys_dlg_submit').on('click',submitdata);
                $("#sys_dlg").modal({backdrop: false});
            });
        }
    ...
    function delInRow(id)
    {
        if (confirm('确认删除数据?')) {
            var ids = [];
            ids.push(id);
            $.post('/szny/index.php/Admin/Twicedatam/del', {ids: ids.join(',')}, function (rep, status) {
                if ('' == rep) {
                    $('#atpbiztable').bootstrapTable('refresh')
                }
                else {
