			...
			<div class="row row-lg">
				<div class="col-sm-12">
					...
					<iframe id = "message" frameborder=0 width=100% height="1580px" marginheight=0 marginwidth=0 scrolling=no
                            src='/szny/index.php/Admin/RgGeneral/regionshow?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=<?php echo ($_GET['tabindex']); ?>&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>'></iframe>
				</div>
			</div>
		</div>
	</div>
...
//        联动左树右页
     ...
     ATP_REGIONJUMP = function (region_id) {
         ...
         treeObj.selectNode(node);
         $('#contentframe').attr('src',"/szny/index.php/Admin/Oallview/index2?rgn_atpid=" + region_id);
     };
</script>
