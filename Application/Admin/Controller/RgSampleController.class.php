...
class RgSampleController extends BaseAuthController
{
    public function index()
    {
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：【园区漫游】 / 【示例:雇员管理】");
        $this->display();
    }
    ...
    public function add()
    {
        ...
        $this->assignDsEmpOrg();
        $this->display();
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：【园区漫游】 / 【示例:雇员管理】 / 【添加】");
    }
    ...
    public function del()
    {
        ...
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：【园区漫游】 / 【示例:雇员管理】 / 【删除】");
    }
...
order by t.edpm_empid , t1.dpm_name asc ";
    ...
    public function renewPassword(){
        ...
        $this->display();
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：【园区漫游】 / 【示例:雇员管理】 / 【修改密码】");
    }
