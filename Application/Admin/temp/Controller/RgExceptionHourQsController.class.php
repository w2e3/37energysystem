...
class RgExceptionHourQsController extends BaseAuthController
{

    public function index(){
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：$this->ATPLocationName / 【时报缺失】");
    ...
    public function getData(){
        ...
        $sql_select = $this->buildSql($sql_select, "t.deve_type  = '时报缺失'");
        $sql_count = $this->buildSql($sql_count, "t.deve_type  = '时报缺失'");
    ...
    public function deal(){
        ...
        $this->display();
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：$this->ATPLocationName / 【时报缺失】 / 【处理时报异常】");
    }
    ...
    public function ignore(){
        $this->display();
        $this->logSys(session('emp_atpid'),"访问日志","访问页面：$this->ATPLocationName / 【时报缺失】 / 【忽略时报异常】");
    }
