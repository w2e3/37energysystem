...
//        $duibi = $this->makeRegionCompareChart2();
    ...
    public function makeRegionCompareChart1()
    {
        ...
        $tdata["qnydl"]=$yearcou['ydl'];
        $tdata["qnysl"]=$yearcou['ysl'];
        $tdata["qnynl"]=$yearcou['ynl'];
        $tdata["qnyll"]=$yearcou['yll'];
        $tdata["byydl"]=$monthcou['ydl'];
        $tdata["byysl"]=$monthcou['ysl'];
        $tdata["byynl"]=$monthcou['ynl'];
        $tdata["byyll"]=$monthcou['yll'];
        $tdata["syydl"]=$monthcouf['ydl'];
        $tdata["syysl"]=$monthcouf['ysl'];
        $tdata["syynl"]=$monthcouf['ynl'];
        $tdata["syyll"]=$monthcouf['yll'];
        return $tdata;
    }
