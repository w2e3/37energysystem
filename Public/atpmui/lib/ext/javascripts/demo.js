...
dd.ready(function() {
    ...
    dd.runtime.permission.requestAuthCode({
        ...
        onSuccess: function (info) {
            ...
            //location.href = "http://www.sgqnmall.com/dingding/corp/test.php?authcode"+info.code;
            $.ajax({
                url: 'http://www.sgqnmall.com/xterm/index.php/Frontend/Teacher/getUserinfo',
                type:"POST",
                ...
                success: function (data, status, xhr) {
                    ...
                    //    logger.i('user nickname: ' + info.nickName);
